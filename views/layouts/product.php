...
<?php $this->beginPage() ?>
    ...
    <?php $this->registerJsFile('/js/cloud-zoom.js', ['depends' => [\yii\bootstrap\BootstrapAsset::className()]]); ?>
    <?php $this->registerJsFile('/js/jquery.flexslider.js', ['depends' => [\yii\bootstrap\BootstrapAsset::className()]]); ?>
    <?php $this->registerJsFile('/js/countdown.js', ['depends' => [\yii\bootstrap\BootstrapAsset::className()]]); ?>
