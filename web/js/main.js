jQuery(document).ready(function() {
    ...
    function showCart(modalcart) {
        $('#modal-cart .modal-body').html(modalcart);
        $('#modal-cart').modal();
    }

    /*
    function showHoverCart(hovercart) {
        $('#cart-hover').html(hovercart);
    }
    ...
    */
    ...
    $('.order-detail-content .action').on('click', '.del-item', function(){
        var id = $(this).data('id');
        $.ajax({
            url: '/cart/del-item',
            data: {id: id},
